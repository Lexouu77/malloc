...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2017/12/09 12:50:19 by ahamouda          #+#    #+#             */
/*   Updated: 2017/12/09 22:02:02 by ahamouda         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
size_t			get_map_size(size_t size, size_t type)
{
	...
	return (ALIGN(ALIGN_GETPAGESIZE, size + SZ_BLOCK)); // remove SZ_BLOCK if showmemalloc ?
}
